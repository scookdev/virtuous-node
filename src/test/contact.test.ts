...
describe('Contact', () => {
  ...
  describe('#getTotalGiving', () => {
    describe('when passed the year', () => {
      it.only('returns the total giving for the year', async () => {
        const contact = new Contact();
        const totalGiving = await contact.getTotalGiving(1633, 2024);
        console.log('Total Giving for 2024', totalGiving);
      });
    });
